...
use Yepsua\SmarTwig\Twig\Node\SortableNode;

class SortableTokenParser extends CommonTokenParser {
  ...
  public function getNodeInstance(\Twig_Token $token){
    return new SortableNode($this->getNames(), new \Twig_Node($this->getValues()), $token->getLine(), $this->getTag());
  }
