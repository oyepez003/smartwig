...
class UIAddonsExtension extends UIWidgetExtension {
  ...
  public function getTokenParsers() {
    return array(
        new \Yepsua\SmarTwig\Twig\TokenParser\BlockUITokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\BoxTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\ColorpickerTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\NotifyTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\HotkeyTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\IdleMonitorTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\KeypadTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\CalculatorTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\LayoutTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\MaskTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\FormWizardTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\AjaxFormTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\ValidationTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\BookletTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\CycleTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\RingTokenParser(),
        new \Yepsua\SmarTwig\Twig\TokenParser\UploadTokenParser(),
    );
  }
